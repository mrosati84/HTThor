// Code generated by tools/gen-help-text.py from the frozen capture corpus; the
// generator is NOT in this tree — no *.py is, and it was never committed — so
// refreshing the two texts means re-creating it first. docs/PROVENANCE.md
// section 3 records that and this file's sha256. DO NOT EDIT. With the generator
// back in tools/, refreshing was: python3 tools/gen-help-text.py
//
